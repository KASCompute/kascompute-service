# KASCompute - PRO Local Node Starter (Node 03)

$ErrorActionPreference = "Stop"

Write-Host "Starting KCT PRO LOCAL Node 03..." -ForegroundColor Cyan

$backend = "http://127.0.0.1:8080"
$nodeName = "kct-pro-node-03"
$keyFile = "pro_node3_key.txt"
