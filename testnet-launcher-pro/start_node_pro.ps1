# KASCompute - PRO Local Node Starter (Node 01)

$ErrorActionPreference = "Stop"

Write-Host "Starting KCT PRO LOCAL Node 01..." -ForegroundColor Cyan

# --- CONFIG ---
$backend = "http://127.0.0.1:8080"
$nodeName = "kct-pro-node-01"
$keyFile = "pro_node_key.txt"
